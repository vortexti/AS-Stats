...
if ( $my_asn ) {
  ...
  $select_ix .= '<option value="">Selecionar IX</option>';
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <?php if ( $my_asn ) { ?>
                ...
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Meu(s) IX</h3>
                  </div>
                  <div class="box-body">
                  	<?php echo $select_ix; ?>
                  </div>
            ...
            <?php } ?>
                ...
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <h3 class="box-title">Pesquisar IX</h3>
                  </div>
                  <div class="box-body">
                    <input type="text" class="form-control" name="name_ix" placeholder="Pesquisar IX" id="peeringdb" data-provide="typeahead" autocomplete="off" value="<?php echo htmlspecialchars($name_ix); ?>">
