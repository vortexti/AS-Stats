...
if ( isset($_GET['as']) ) {
  ...
  $title = "AS-Stats | Histórico para AS".$as.": ".$asinfo['descr'];
  $header = 'Histórico para AS' . $as;
  ...
  $title = "AS-Stats | Histórico";
  $header = 'Histórico para AS';
  $header_small = "";
            ...
            <div class="col-lg-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Pesquisar AS</h3>
                ...
                <div class="box-body">
                  ...
                  <input type="text" class="form-control menu-input" name="as" placeholder="Pesquisar AS" value="<?php echo $val_searchas; ?>">
        ...
        <div class="col-lg-10">
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Diariamente</h3>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Semanalmente</h3>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Mensalmente</h3>
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Anualmente</h3>
